...
telconnection.on('ready', function(prompt) {
 telconnection.exec(cmd, function(err, response) {
    console.log(response)
  })
})
telconnection.on('timeout', function() {
  console.log('socket timeout!')
  telconnection.end()
})

telconnection.on('close', function() {
